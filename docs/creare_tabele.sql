...
insert into familie values(1,105,100);
insert into familie values(1,104,106);
insert into familie values(1,105,106);
insert into familie values(1,107,105);
insert into familie values(1,109,105);
insert into familie values(1,108,104);
/
--select * from users;
