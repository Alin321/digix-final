...
insert into user_files values(20,103,'poza','upload/andreea.sacara@yahoo.com/poza1.jpg',sysdate,'P');
...
/
select * from user_friends where (user_id=102 and friend_id=102) or (user_id=102 and friend_id=100);